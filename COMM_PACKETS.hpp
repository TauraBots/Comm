// Comm/COMM_PACKETS.hpp
#ifndef COMM_PACKETS_HPP_ // Alterada guarda de inclusão
#define COMM_PACKETS_HPP_ // Alterada guarda de inclusão
...
// Para portabilidade direta, manteremos `typedef enum`.
// Melhoria C++ opcional: `enum class nrf_main_packet_type_t { ... };`
typedef enum {
...
// Melhoria C++ opcional: `enum class vsss_command_subtype_t { ... };`
typedef enum {
...
// Melhoria C++ opcional: `enum class ssl_command_subtype_t { ... };`
typedef enum {
...
// Melhoria C++ opcional: `struct __attribute__((packed)) vsss_payload_t { ... };`
...
// Melhoria C++ opcional: `struct __attribute__((packed)) ssl_payload_t { ... };`
typedef struct __attribute__((packed)) {
...
// Melhoria C++ opcional: `struct __attribute__((packed)) debug_text_payload_t { ... };`
typedef struct __attribute__((packed)) {
    char text[DEBUG_TEXT_MAX_LEN];
} debug_text_payload_t;

// Melhoria C++ opcional: `struct __attribute__((packed)) comm_packet_header_t { ... };`
typedef struct __attribute__((packed)) {
...
// Melhoria C++ opcional: `struct __attribute__((packed)) comm_packet_t { ... };`
typedef struct __attribute__((packed)) {
