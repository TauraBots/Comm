// Comm/COMM.hpp
#ifndef COMM_HPP_ // Alterada guarda de inclusão
#define COMM_HPP_ // Alterada guarda de inclusão
...
// Melhoria C++ opcional: `enum class comm_robot_type_t { ... };`
typedef enum {
...
// Melhoria C++ opcional: `enum class comm_node_mode_t { ... };`
typedef enum {
